...
<div class="container py-5 text-white bg-gray-900">
    ...
    <p class="text-gray-500">Kasih Kita adalah platform donasi yang membantu menyalurkan kebaikan kepada mereka yang membutuhkan dengan transparan dan terpercaya.</p>
</div>
@endsection
